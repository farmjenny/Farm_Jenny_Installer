...
###########################################################################
### Farm Jenny LTE BR HAT + Nimbelink NL-SW-LTE-QBG95 Modem Class #########
###########################################################################

class FarmJennyHatBg95:
	board = "" # shield name (LTE Border Router HAT with Quectel BG95-based Modem)
	ip_address = "" # ip address       
	domain_name = "" # domain name   
	port_number = "" # port number 
	timeout = TIMEOUT # default timeout for function and methods on this library.
	...
	# This API exposes basic GNSS data using AT commands.  More advanced functionality
	# may be available through other interfaces.
	# BG95 GNSS output is in the format:
	# 	+QGPSLOC: <UTC>,<latitude>,<longitude>,<hdop>,<altitude>,<fix>,<cog>,<spkm>,<spkn>,
	# 	<date>,<nsat>
	# BG95 includes OPTIONAL power for an active antenna, controlled by GPIO64 of the modem.
	#******************************************************************************************
